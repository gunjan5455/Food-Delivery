...
const placeOrder = async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      success_url: `${"https://f00d-delivery-react-user-bygunjan.onrender.com"}/verify?success=true&orderId=${
        newOrder._id
      }`,
      cancel_url: `${"https://f00d-delivery-react-user-bygunjan.onrender.com"}/verify?success=false&orderId=${
        newOrder._id
      }`,
    });
